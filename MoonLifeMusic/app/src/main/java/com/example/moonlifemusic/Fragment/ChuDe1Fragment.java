...
public class ChuDe1Fragment extends Fragment {
     View view;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_chude1,container,false);
        recyclerView = view.findViewById(R.id.rcv_chude1);
        textView = view.findViewById(R.id.txtchude1);
        textViewxemthem = view.findViewById(R.id.xemhthemchude1);
    ...
    private void getData() {
        ...
        Call<List<Listmucisc>> callback = dataservice.GetDataChuDe1();
        callback.enqueue(new Callback<List<Listmucisc>>() {
            ...
            public void onResponse(Call<List<Listmucisc>> call, Response<List<Listmucisc>> response) {
                ArrayList<Listmucisc> chude1Playlist = (ArrayList<Listmucisc>) response.body();
                chude1Adapter = new Chude1Adapter(getActivity(),chude1Playlist);
