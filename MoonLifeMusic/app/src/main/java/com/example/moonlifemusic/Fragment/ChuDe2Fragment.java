...
public class ChuDe2Fragment extends Fragment {
     View view;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_chude2,container,false);
        recyclerView = view.findViewById(R.id.rcv_chude2);
        textView = view.findViewById(R.id.txtchude2);
        textViewxemthem = view.findViewById(R.id.xemhthemchude2);
    ...
    private void getData() {
        ...
        Call<List<Listmucisc>> callback = dataservice.GetDataChuDe2();
